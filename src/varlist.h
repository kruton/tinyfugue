...
varstr (VAR_TF_FORK_VERSION,"TF_FORK_VERSION",DEFAULT_TF_FORK_VERSION,NULL)
...
varflag(VAR_pcre2_compat, "pcre2_compat",	TRUE,		NULL)
varflag(VAR_pcre2_jit,	"pcre2_jit",	TRUE,		NULL)
